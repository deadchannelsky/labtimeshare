...
INSERT INTO "new_ShellGrant" ("createdAt", "id", "isActive", "linuxUsername", "requestId", "revokedAt", "sshPrivateKey", "sshPublicKey") SELECT "createdAt", "id", "isActive", "linuxUsername", "requestId", "revokedAt", "sshPrivateKey", "sshPublicKey" FROM "ShellGrant";
